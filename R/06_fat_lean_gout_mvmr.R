...
capture.output(mvmr_ivw, file = "results/05_fat_lean_gout_mvmr_ivw.txt")
capture.output(mvmr_egger, file = "results/05_fat_lean_gout_mvmr_egger.txt")
capture.output(pleio, file = "results/05_fat_lean_gout_mvmr_pleiotropy.txt")
capture.output(strength, file = "results/05_fat_lean_gout_mvmr_strength.txt")
